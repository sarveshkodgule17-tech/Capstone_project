    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 to-blue-50/50 p-4">
      ...
      >
        ...
        <div className="bg-white p-8 rounded-3xl shadow-xl shadow-blue-900/5 border border-slate-100">
          ...
          <p className="text-slate-500 text-center mb-8 text-sm">Join VisionAssistant diagnostics</p>
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            ...
            <button 
              type="submit"
              className="w-full inline-flex items-center justify-center rounded-xl text-md font-bold text-white bg-blue-600 hover:bg-blue-700 h-12 mt-4 transition-all shadow-lg hover:shadow-blue-500/30"
            >
              Create Account
            </button>
          </form>
